...
INSERT INTO ansatt(ans_id,fornavn,etternavn,timelonn) VALUES(1001, 'Ole', 'Hansen', 330);
INSERT INTO ansatt(ans_id,fornavn,etternavn,timelonn) VALUES(1002, 'Anne', 'Vik', 320);
INSERT INTO ansatt(ans_id,fornavn,etternavn,timelonn) VALUES(1003, 'Eva', 'Jensen', 400);
INSERT INTO ansatt(ans_id,fornavn,etternavn,timelonn) VALUES(1004, 'Jens', '�s', 370);

INSERT INTO prosjekt(prosj_id,prosj_tittel,kunde,budsjett,timefaktor,leder_ans_id)
VALUES(101, 'Frukt og gr�nt i massevis', 'Haloween', 430000, 1.7, 1004);
INSERT INTO prosjekt(prosj_id,prosj_tittel,kunde,budsjett,timefaktor,leder_ans_id)
VALUES(102, 'Farsdagsmoro', 'Barnehagene AS', 355000, 1.3, 1004);

INSERT INTO prosjektkostnader(prosj_kost_id,dato,belop,tekst,faktura_sendt,prosj_id)
