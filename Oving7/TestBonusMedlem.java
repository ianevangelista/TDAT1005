...
class TestBonusMedlem {
  public static void main(String[] args) throws Exception {
    ...
    SoelvMedlem b3 = new SoelvMedlem(b2.getMedlnr(), b2.getPersonalia(), b2.getInnmeldtDato(), b2.getPoeng());
    b3.registrerPoeng(50000);
    if (b3.finnKvalPoeng(testdato) == 90000 && b3.getPoeng() == 90000) {
      System.out.println("Test 4 ok");
    }

    GullMedlem b4 = new GullMedlem(b3.getMedlnr(), b3.getPersonalia(), b3.getInnmeldtDato(), b3.getPoeng());
    ...
    Personalia p1 = new Personalia("Ian", "Evangelista", "ian@gmail.com", "Passord123");
    int medlem1 = arkiv.nyMedlem(p1,testdato);
    arkiv.registrerPoeng(medlem1, 20000);
    System.out.println(arkiv.finnPoeng(medlem1, "Passord123"));
    System.out.println(arkiv.getMedlem(0).getClass());
    arkiv.registrerPoeng(medlem1, 100000);
    System.out.println(arkiv.finnPoeng(medlem1, "Passord123"));
